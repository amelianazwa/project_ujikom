...
{
    use HasFactory;
    protected $fillable = ['id','code_peminjaman','id_anggota','jenis_kegiatan','id_barang','jumlah_pinjam','id_ruangan','tanggal_peminjaman','tanggal_pengembalian','waktu_peminjaman','cover'];
...
{
    return $this->hasMany(p_barang::class, 'id_pm_barang', 'id');
}
